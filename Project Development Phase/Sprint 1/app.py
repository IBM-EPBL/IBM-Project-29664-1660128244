...
connection = ibm_db.connect("DATABASE=bludb;HOSTNAME=21fecfd8-47b7-4937-840d-d791d0218660.bs2io90l08kqb1od8lcg.databases.appdomain.cloud;PORT=31864;SECURITY=SSL;SSLServerCertificate=db2.crt;UID=bxr06206;PWD=gEMlHs5QLV6LyGB0"," "," ")

load_dotenv()   #load keys from .env
sg = sendgrid.SendGridAPIClient(api_key = os.environ.get('Plasma_API_KEY'))   #set SendGrid API Key
from_email = Email("plasmadonationdomain@gmail.com")     #the address that sends emails to the users
